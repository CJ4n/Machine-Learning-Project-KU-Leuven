...
class CustomPredictFunction:
    def __init__(self, env, checkpoint_path: str = None):
        ...
        if checkpoint_path is None:
            ...
            checkpoint_path = "runs/grid_search_multi_20250512_002803/c1000000_yKL_r512_mod_rewards/weights/best_1747002483.5332408_multi_ppo_311.43"
    ...
    def __call__(self, observation, agent, *args, **kwargs):
        if "shared_archer_policy" not in self.modules:
            raise ValueError(f"No policy found for agent {agent}")

        rl_module = self.modules["shared_archer_policy"]
